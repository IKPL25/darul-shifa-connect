...
export const strings = {
  en: {
    ...
    p2: {
      ...
      myPatientsNote: "Your Google account can book for yourself and your family members.",
      addPatient: "Add Patient",
      editPatient: "Edit Patient",
      appointmentFor: "Who is this patient?",
      self: "Self",
      otherPatient: "Other Patient",
      relation: "S/O / D/O / W/O",
      noPatients: "No patient records yet. Add your first one.",
      patientSaved: "Patient record saved",
      remove: "Remove",
      confirmRemove: "Remove this patient record?",
      accountEmail: "Google Account",
      selfBadge: "Self",
      patientAlreadyExists: "A patient with this mobile already exists in your list.",
  ...
  ur: {
    ...
    p2: {
      ...
      myPatientsNote: "آپ اپنے گوگل اکاؤنٹ سے اپنے لیے اور اہلِ خانہ کے لیے بکنگ کر سکتے ہیں۔",
      addPatient: "مریض شامل کریں",
      editPatient: "مریض میں ترمیم",
      appointmentFor: "یہ مریض کون ہے؟",
      self: "خود",
      otherPatient: "دوسرا مریض",
      relation: "ولد / بنت / زوجہ",
      noPatients: "ابھی کوئی مریض ریکارڈ نہیں۔ پہلا ریکارڈ شامل کریں۔",
      patientSaved: "مریض کا ریکارڈ محفوظ ہو گیا",
      remove: "حذف کریں",
      confirmRemove: "کیا یہ مریض ریکارڈ حذف کریں؟",
      accountEmail: "گوگل اکاؤنٹ",
      selfBadge: "خود",
      patientAlreadyExists: "اس موبائل نمبر کا مریض آپ کی فہرست میں پہلے سے موجود ہے۔",
